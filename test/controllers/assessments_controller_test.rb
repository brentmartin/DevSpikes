...
class AssessmentsControllerTest < ActionController::TestCase
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post :create, assessment: { answer: @assessment.answer, description: @assessment.description, question: @assessment.question, title: @assessment.title }
    end
  ...
  test "should update assessment" do
    patch :update, id: @assessment, assessment: { answer: @assessment.answer, description: @assessment.description, question: @assessment.question, title: @assessment.title }
    assert_redirected_to assessment_path(assigns(:assessment))
  end
