...
ActiveRecord::Schema.define(version: 20160506021405) do
  ...
  add_index "evaluations", ["survey_id"], name: "index_evaluations_on_survey_id"
  ...
  add_index "surveys", ["assessment_id"], name: "index_surveys_on_assessment_id"
